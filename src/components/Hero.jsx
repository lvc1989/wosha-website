...
export default function Hero({ businessName, tagline, branchCount, headlineOverride, subheadlineOverride }) {
  ...
  return (
    <section id="top" className="relative overflow-hidden" style={{ background: "linear-gradient(160deg, #0B1B33 0%, #0F2545 55%, #0B1B33 100%)", minHeight: "92vh" }}>
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-40 pb-24 flex flex-col items-start" style={{ minHeight: "92vh" }}>
        ...
        {headlineOverride ? (
          <h1 className="font-display font-bold text-white leading-[0.95] mb-6" style={{ fontSize: "clamp(2.75rem, 7vw, 5.5rem)" }}>{headlineOverride}</h1>
        ) : (
          <h1 className="font-display font-bold text-white leading-[0.95] mb-6" style={{ fontSize: "clamp(2.75rem, 7vw, 5.5rem)" }}>
